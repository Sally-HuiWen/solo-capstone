...
def seed_daily_logs():
    daily_log1 = DailyLog(kid_id=1, title = 'Six-year-old Birthday Party', content ='ELsa invited all her kindergarten classmates to attend her birthday party. She had so much fun', created_at=datetime(2024,6,6))
    daily_log2 = DailyLog(kid_id=1, title = 'First Day of Kindergarten', content ='First day of kindergarten! She is a elementary student now! ', created_at=datetime(2023,8,16))
    daily_log3 = DailyLog(kid_id=1, title = 'Running Near Carmel-by-the-sea', content ='chasing waves near the beautiful beach!', created_at=datetime(2023,7,15))
    daily_log4 = DailyLog(kid_id=1, title = 'Ice-skating Progress ', content ='ELsa just unlock the skill of  backward crossover! ', created_at=datetime(2023,5,20))
    daily_log5 = DailyLog(kid_id=2, title = 'Ballet Performance', content ='Well done with your first ballet performance, Anna!', created_at=datetime(2024,6,2))
    daily_log6 = DailyLog(kid_id=2, title = 'Raining Day', content ='jumping muddy puddles under the rain', created_at=datetime(2024,3,18))
    daily_log7 = DailyLog(kid_id=2, title = 'Show Time', content ='Enjoying  disney on ice show!', created_at=datetime(2023,11,3))
    ...
    daily_log15 = DailyLog(kid_id=4, title = 'Smile', content ="Olaf's first cute smile!", created_at=datetime(2023,10,6))
    daily_log16 = DailyLog(kid_id=4, title = 'Birth', content ='Welcome to this beautiful world!', created_at=datetime(2023,9,9))
